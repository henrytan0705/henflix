...
chicken_little.photo.attach(io: chickenLittle_photo, filename:"chicken_little.jpg")
chicken_little.video_url.attach(io:chickenLittle_video, filename:"chicken_little.mp4")
